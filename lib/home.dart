  ...
  findAge(DateTime birthDate) {
    ...
    if (birthDate.isBetween(
      ...
      rteStd = "-";
        ...
        from: DateTime.parse('2016-06-01'), to: DateTime.parse('2017-05-31'))) {
      calculateAge = 6;
      standard = "1";
      rteStd = "-";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2015-06-01'), to: DateTime.parse('2016-05-31'))) {
      calculateAge = 7;
      standard = "2";
      rteStd = "1";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2014-06-01'), to: DateTime.parse('2015-05-31'))) {
      calculateAge = 8;
      standard = "3";
      rteStd = "2";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2013-06-01'), to: DateTime.parse('2014-05-31'))) {
      calculateAge = 9;
      standard = "4";
      rteStd = "3";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2012-06-01'), to: DateTime.parse('2013-05-31'))) {
      calculateAge = 10;
      standard = "5";
      rteStd = "4";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2011-06-01'), to: DateTime.parse('2012-05-31'))) {
      calculateAge = 11;
      standard = "6";
      rteStd = "5";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2010-06-01'), to: DateTime.parse('2011-05-31'))) {
      calculateAge = 12;
      standard = "7";
      rteStd = "6";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2009-06-01'), to: DateTime.parse('2010-05-31'))) {
      calculateAge = 13;
      standard = "8";
      rteStd = "7";
    } else if (birthDate.isBetween(
        from: DateTime.parse('2008-06-01'), to: DateTime.parse('2009-05-31'))) {
      calculateAge = 14;
      standard = "-";
      rteStd = "8";
    } else {
...
/*    monthDiff = today.month - birthDate.month;
    ...
    calculateAge = int.parse(yourAgeList[0].toString().replaceAll("Years:", "").trim());

    yourMonth == int.parse(yourAgeList[1].toString().replaceAll("Months:", "").trim());

    yourDay == int.parse(yourAgeList[2].toString().replaceAll("Days:", "").trim());
